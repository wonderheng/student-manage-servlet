...
<head>
    ...
    <script type="text/javascript" src="assets/js/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js"></script>
...
<div region="north" style="height: 80px;background-color: #E0EDFF">
    ...
    <div style="padding-top: 50px;padding-right: 20px;">当前用户：&nbsp;<font color="red">${currentUser.userName }
    </font>&nbsp;&nbsp; 在线人数：<font color="red"><%=application.getAttribute("onlineUser")%>
    </font>
...
<div region="south" style="height: 25px;" align="center">版权所有:&nbsp;&nbsp;&nbsp;<a href="http://www.wonderheng.top">wonderheng</a>
</div>
</body>
</html>