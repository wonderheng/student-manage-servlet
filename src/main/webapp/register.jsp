...
<div class="container demo-1">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <div class="logo_box">
                <h3>欢迎注册</h3>
                <form action="register" id="registerForm" method="post" name="f">
                    ...
                    <div class="input_outer">
                        <span class="us_uer"></span>
                        <input name="passwordRepeat" class="text" style="color: #FFFFFF !important; position:absolute; z-index:100;"
                               value=""
